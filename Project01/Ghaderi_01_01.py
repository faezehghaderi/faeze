...
class LeftFrame:
	...
	def __init__(self, root, master, debug_print_flag=False):
		...
		self.figure = plt.figure(figsize=(12,5.5))
		...
		self.activation_function_dropdown = tk.OptionMenu(self.controls_frame, self.activation_function_variable,
		                                                  "Sigmoid", "Linear", "Hyperbolic Tangent", "RELU", command=lambda
	...
	def display_activation_function(self):
		...
		activation = Ghaderi_01_02.calculate_activation_function(self.input_weight, self.bias, input_values,
